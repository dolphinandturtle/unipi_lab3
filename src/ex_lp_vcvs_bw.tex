...
\end{equation}
per determinare la fase si usa \ref{eq:da-tfunc-a-fase} e siccome il semi-piano occupato \'e quello immaginario negativo
allora l'opposto della parte immaginaria viene messa a denominatore
\begin{equation*}
  \phi(\omega) = \arctan\left(\frac{1 - 2R^2C^2\omega^2}{2RC\omega}\right)
\end{equation*}
\begin{equation}
  \label{eq:lp-vcvs-butterworth-phase}
  \colorbox{blu}{\boxed{\phi(f) = \arctan\left(\frac{1 - 8\pi^2R^2C^2f^2}{4\pi RCf}\right)}}
\end{equation}
...
\begin{equation}
  ...
  \colorbox{blu}{\boxed{f = \frac{1}{2\sqrt2\cdot RC}}}
\end{equation}
