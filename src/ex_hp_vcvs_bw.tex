...
Le parti reali ed immaginarie del filtro sono, rispettivamente
\begin{equation*}
  \begin{gathered}
    \begin{cases}
    ...
    \end{cases} \\ \implies
    G(\omega) = \frac{\sqrt{(-2R^2C^2\omega^2)^2}}{\sqrt{(1-2R^2C^2\omega^2)^2 + (2RC\omega)^2}} = 
    \frac{2R^2C^2\omega^2}{\sqrt{1+4R^4C^4\omega^4}}
  \end{gathered}
\end{equation*}
\begin{equation}
...
\begin{equation*}
  \begin{gathered}
    \mathcal{R}_{\omega}[H(s)] = (-2R^2C^2\omega^2)(1-2R^2C^2\omega^2) \\
    \mathcal{I}_{\omega}[H(s)] = -(-2R^2C^2\omega^2)(2RC\omega) = 4R^3C^3\omega^3 > 0
  \end{gathered}
\end{equation*}
quindi la fase $\phi$ viene calcolata attraverso la \ref{eq:da-tfunc-a-fase-immaginario-positivo}
\begin{equation*}
  \phi(\omega) = \frac{\pi}{2} + \arctan\left(\frac{1-2R^2C^2\omega^2}{2RC\omega}\right)
\end{equation*}
\begin{equation}
