...
\begin{equation}
  ...
  \begin{gathered}
    ...
    \mathcal{R}_{\omega}[H(s)] = \frac{(\mathcal{R}_{\omega}^N\mathcal{R}_{\omega}^D + \mathcal{I}_{\omega}^N\mathcal{I}_{\omega}^D)}{(\mathcal{R}_{\omega}^D)^2 + (\mathcal{I}_{\omega}^D)^2} \quad
    \mathcal{I}_{\omega}[H(s)] = \frac{(\mathcal{I}_{\omega}^N\mathcal{R}_{\omega}^D - \mathcal{R}_{\omega}^N\mathcal{I}_{\omega}^D)}{(\mathcal{R}_{\omega}^D)^2 + (\mathcal{I}_{\omega}^D)^2}
  \end{gathered}
\end{equation}
...
\begin{equation}
  ...
  \begin{gathered}
    G(\omega)^2 \equiv H(j\omega)\overline{H(j\omega)} = \frac{(\mathcal{R}_{\omega}^N)^2 + (\mathcal{I}_{\omega}^N)^2}{(\mathcal{R}_{\omega}^D)^2 + (\mathcal{I}_{\omega}^D)^2}
  \end{gathered}
\end{equation}
