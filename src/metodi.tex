...
\paragraph{Fase}
\begin{equation}
  \label{eq:da-tfunc-a-fase}
  \begin{gathered}
    H(s) = \left(\sum_{i=0}^n sa_i\right)^{-1} \\
    \implies \phi(\omega) = \frac{\mathcal{I}_{\omega}^N\mathcal{R}_{\omega}^D - \mathcal{R}_{\omega}^N\mathcal{I}_{\omega}^D}{\mathcal{R}_{\omega}^N\mathcal{R}_{\omega}^D + \mathcal{I}_{\omega}^N\mathcal{I}_{\omega}^D}
  \end{gathered}
\end{equation}
